                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="suratPermintaanPembayaranSPP"
                                        ...
                                        >
                                    <label class="custom-file-label" for="suratPermintaanPembayaranSPP">{{ $data->surat_permintaan_pembayaran_spp ?? 'Choose File' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="rab" name="rab" value="{{ old('rab') }}" >
                                    <label class="custom-file-label" for="rab">{{ $data->rab ?? 'Choose File' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="pernyataanPertanggungJawaban"
                                        name="pernyataanPertanggungJawaban" value="{{ old('pernyataanPertanggungJawaban') }}" >
                                    <label class="custom-file-label" for="pernyataanPertanggungJawaban">{{ $data->pernyataan_pertanggungjawaban ?? 'Choose File' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="dpa" name="dpa" value="{{ old('dpa') }}" >
                                    <label class="custom-file-label" for="dpa">{{ $data->belanja_dpa ?? 'Choose File' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="skTimPelaksana">{{ $data->sk_tim_pelaksana }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-9">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="skDasarKegiatan">{{ $data->sk_dasar_kegiatan ?? 'Choose File' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="offset-sm-3 col-sm-9">
                                ...
                                <input action="action" onclick="window.history.go(-1); return false;" type="submit" value="BATAL" class="btn btn-danger">
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
