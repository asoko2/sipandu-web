@extends('layout.app')
@section('title', 'Tolak Pengajuan Anggaran')
@section('page-nav')
    <div class="col-sm-6">
        <h1 class="m-0">Tolak Pengajuan Anggaran</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tolak Pengajuan Anggaran</li>
        </ol>
    </div><!-- /.col -->
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card card-info">
                ...
                @endif
                <form class="form-horizontal" action="{{ route('tolak-ajuan', $data->id) }}" method="POST"">
                    @csrf
                    <div class="card-body">
